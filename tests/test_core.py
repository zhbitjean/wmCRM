...
def sample(db):
    ...
    contact=Contact(first_name="David",last_name="Chen",display_name="David Chen",phone="(917) 555-1234",phone_normalized="9175551234",email="david@gmail.com",company=company)
...
def test_global_search_all_key_fields(db):
    *_,project=sample(db)
    for query in ["155 Stuy","1K","David","ABC Construction","917-555-1234","gmail.com","Interior Reno"]:
